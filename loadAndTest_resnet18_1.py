...
def test_model(model, criterion):
    print("Inside test model")
    test_time.start()
    running_loss = 0.0
    running_corrects = 0
    
    image_time = tm.ResumableTimer()
    ...
    for inputs, labels in dataloaders:
        ...
        with torch.no_grad():
            ...
            image_time.pause()
            image_elapsed = image_time.get_actual_time()
            print('Test complete in {:.0f}m {:.2f}s'.format(image_elapsed // 60, image_elapsed % 60))
